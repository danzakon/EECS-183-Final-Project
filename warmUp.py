...
def getColor(favoriteColors, name):
    ...
    'green'
    """
    colorList = favoriteColors.get(name, [])
    return colorList[0]
    pass
...
def translate(vocab, word, language):
    ...
    'riviere'
    """
    wordDict = vocab.get(word, {})
    return wordDict.get(language, 'N/A')
    pass
...
def nestedDictionary3D(L1, L2):
    ...
    True
    """
    D = {l1: {l2: {} for l2 in L2} for l1 in L1}
    return D
    pass
...
def valueFrom3D(D, K1, K2, K3):
    ...
    'abora'
    """
    return D.get(K1, 'N/A').get(K2, 'N/A').get(K3, 'N/A')
    pass
